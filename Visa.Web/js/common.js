; (function ($) {
    ...
    $(document).ready(function (e) {
        ...
        $('footer').html("&copy; " + (new Date()).getFullYear() + " GVC Global Group. All Rights Reserved.");
    ...
    function remove_isotope_styles() {
        $('.country_list_wrapper ul > li').each(function (index, element) {
            ...
            this.isotope_styles = { 'position': $this.css('position'), 'left': $this.css('left'), 'top': $this.css('top')  };
    ...
    if (ieVersion == null || ieVersion > 8) {
        ...
        window.map_image_loaded = function (img) {
            ...
            if (hover_wrapper.children('img').length == 0) {
                ...
                var image_dimension = { width: $img.width(), height: $img.height() };
