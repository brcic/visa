...
{
    public class vFileController : Controller
    {
        ...
        public ActionResult mUpload()
        {
            ...
            info =upFile(pathbase, filetype, size); //获取上传状态
     ...
     */
        public Hashtable upScrawl(HttpContext cxt, string pathbase, string tmppath, string base64Data)
        {
            ...
            try
            {
                ...
                fs = System.IO.File.Create(uploadpath + filename);
    ...
    */
        ...
        private Hashtable getUploadInfo()
        {
            ...
            infoList.Add("name", System.IO.Path.GetFileName(URL));
            infoList.Add("size", uploadFile.ContentLength);
            infoList.Add("type", System.IO.Path.GetExtension(originalName));
